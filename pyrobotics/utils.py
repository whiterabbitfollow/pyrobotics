...
def generate_random_trajectory(joint_limits, nr_via_points=10, delta_t=0.1, nr_points=500):
    ...
    return calculate_poses(coeffs, nr_via_points, delta_t, nr_points=nr_points)
