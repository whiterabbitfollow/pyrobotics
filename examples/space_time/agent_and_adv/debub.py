...
from examples.space_time.make import make_rrt
from pyrb.mp.planners.local_planners import LocalPlannerSpaceTimeInftyNorm
from pyrb.mp.post_processing.post_processing import LOGGER_NAME_POST_PROCESSING
...
planner = make_rrt(world, state_space_start, max_nr_vertices=int(5e4), local_planner=local_planner)
...
np.save("../../../viz/post_processing/path.npy", path)
...
# print(np.linalg.norm(path_pp[1:, :-1] - path_pp[:-1, :-1], ord=np.inf, axis=1))
#
#
#
